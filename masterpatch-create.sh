...
system_usr_keylayout=( gpio-keys.kl )
...
mkdir -p ~/android/masterpatch/system/usr/keylayout ~/android/masterpatch/system/lib/modules ~/android/masterpatch/system/lib/hw ~/android/masterpatch/system/bin ~/android/masterpatch/system/etc ~/android/masterpatch/system/cameradata
